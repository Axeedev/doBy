...
class UpdateNightTimeInfoUseCase @Inject constructor(
    private val repository: SettingsRepository
) {

    suspend operator fun invoke(notificationTime: NotificationTime) = repository.updateNightTimeInfo(notificationTime)
}